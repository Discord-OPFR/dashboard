...
export type ResponseEquipmentDTO = {
  ...
  emojis: string;
  effects: EffectDTO;
  rankId: ResponseEquipmentDTO.rankId;
  usage: UsageDTO;
  shop: ShopDTO;
  bottle: BottleDTO;
  ms: number;
  type: ResponseEquipmentDTO.type;
  image: ResponseEquipmentDTO.image;
  category: ResponseEquipmentDTO.category;
  /**
...
export namespace ResponseEquipmentDTO {
  export enum rankId {
    BASIC = 'BASIC',
    COMMON = 'COMMON',
    RARE = 'RARE',
